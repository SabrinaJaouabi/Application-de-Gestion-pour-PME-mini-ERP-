...
export const routes: Routes = [
  ...
  // Commandes admin
  { path: 'orders', component: ListComponent, canActivate: [AuthGuard], data: { role: 'ROLE_ADMIN' } },
  { path: 'orders/add', component: AddComponent, canActivate: [AuthGuard], data: { role: 'ROLE_ADMIN' } },
  { path: 'orders/edit/:id', component: EditComponent, canActivate: [AuthGuard], data: { role: 'ROLE_ADMIN' } },
  ...
  // USER seulement
  { path: 'my-orders', component: ListComponent, canActivate: [AuthGuard], data: { role: 'ROLE_USER' } },
